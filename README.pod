...
By default only README.pod is interpreted in the current directory.  To write *.pod scripts go to L<pod|https://perldoc.perl.org/perlpod>. Only one README.pod file per directory is allowed but that directory can have as many as *.pod file as needed!
...
=item * It is needed to install some more dependencies... To install these dependecies go to https://www.cpan.org/.
